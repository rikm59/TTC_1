      ...
      subTypes: [
        {
          ...
          label: 'Standard / Regular Cleaning',
          measurements: [
            { id: 'sqft', label: 'Home Square Footage', unit: 'sq ft', placeholder: '1500', required: true },
            { id: 'bathrooms', label: 'Number of Bathrooms', unit: 'each', placeholder: '2', required: true },
            { id: 'bedrooms', label: 'Number of Bedrooms', unit: 'each', placeholder: '3', required: true },
            { id: 'frequency', label: 'Frequency Discount (1=one-time, 2=monthly, 3=bi-weekly, 4=weekly)', unit: '', placeholder: '1', required: false },
            { id: 'workers', label: 'Number of Cleaners', unit: 'each', placeholder: '2', required: false },
          ],
          defaultMaterials: [
            { name: 'All-Purpose Cleaner (32 oz)', category: 'Supplies', unit: 'bottle', baseUnitCost: 8.00, quantityFormula: 'Math.ceil(sqft/800)', notes: '' },
            { name: 'Bathroom/Toilet Cleaner (32 oz)', category: 'Supplies', unit: 'bottle', baseUnitCost: 6.00, quantityFormula: 'bathrooms', notes: '' },
            { name: 'Glass & Surface Cleaner (32 oz)', category: 'Supplies', unit: 'bottle', baseUnitCost: 6.00, quantityFormula: 'Math.ceil(sqft/1000)', notes: '' },
          ...
          defaultLabor: [
            { description: 'Kitchen & common areas', workers: 1, hoursFormula: 'Math.ceil(sqft*0.13/60 * ((frequency||1)===4 ? 0.85 : (frequency||1)===3 ? 0.90 : 1.0))', ratePerHour: 28 },
            { description: 'Bathrooms', workers: 1, hoursFormula: 'bathrooms * 0.5 * ((frequency||1)===4 ? 0.85 : (frequency||1)===3 ? 0.90 : 1.0)', ratePerHour: 28 },
            { description: 'Bedrooms & hallways', workers: 1, hoursFormula: 'Math.ceil(bedrooms * 0.33 * ((frequency||1)===4 ? 0.85 : (frequency||1)===3 ? 0.90 : 1.0))', ratePerHour: 28 },
          ],
          defaultOverhead: [
            { description: 'Supplies & equipment allocation', costFormula: 'sqft * 0.02' },
            { description: 'Fuel & vehicle', costFormula: '35' },
          ],
        },
        {
          ...
          measurements: [
            ...
            { id: 'bathrooms', label: 'Number of Bathrooms', unit: 'each', placeholder: '2', required: true },
            { id: 'bedrooms', label: 'Number of Bedrooms', unit: 'each', placeholder: '3', required: true },
            { id: 'add_oven', label: 'Clean Oven (0=No, 1=Yes)', unit: '', placeholder: '0', required: false },
            { id: 'add_fridge', label: 'Clean Inside Fridge (0=No, 1=Yes)', unit: '', placeholder: '0', required: false },
            { id: 'add_windows', label: 'Number of Windows (interior)', unit: 'each', placeholder: '0', required: false },
          ],
          defaultMaterials: [
            { name: 'Heavy-Duty Degreaser (32 oz)', category: 'Supplies', unit: 'bottle', baseUnitCost: 10.00, quantityFormula: 'Math.ceil(sqft/600)', notes: '' },
            { name: 'Disinfectant Cleaner (32 oz)', category: 'Supplies', unit: 'bottle', baseUnitCost: 8.00, quantityFormula: 'bathrooms + 1', notes: '' },
            { name: 'Oven/Grill Cleaner', category: 'Supplies', unit: 'bottle', baseUnitCost: 9.00, quantityFormula: '(add_oven||0)', notes: '' },
            { name: 'Microfiber Cloths (pack)', category: 'Supplies', unit: 'pack', baseUnitCost: 12.00, quantityFormula: '2', notes: '' },
            { name: 'Scrub Pads / Brushes (set)', category: 'Supplies', unit: 'set', baseUnitCost: 8.00, quantityFormula: '1', notes: '' },
            { name: 'Glass Cleaner (32 oz)', category: 'Supplies', unit: 'bottle', baseUnitCost: 6.00, quantityFormula: 'Math.ceil((add_windows||0)/5)+1', notes: '' },
            { name: 'Trash Bags (box)', category: 'Supplies', unit: 'box', baseUnitCost: 9.00, quantityFormula: '1', notes: '' },
          ],
          defaultLabor: [
            { description: 'Deep clean kitchen & appliances', workers: 1, hoursFormula: 'Math.ceil(sqft*0.20/60) + (add_oven||0)*0.75 + (add_fridge||0)*0.5', ratePerHour: 32 },
            { description: 'Deep clean bathrooms', workers: 1, hoursFormula: 'bathrooms * 1.0', ratePerHour: 32 },
            { description: 'Bedrooms, closets & dusting', workers: 1, hoursFormula: 'Math.ceil(bedrooms * 0.75)', ratePerHour: 32 },
            { description: 'Windows (interior)', workers: 1, hoursFormula: '(add_windows||0) * 0.25', ratePerHour: 32 },
          ],
          defaultOverhead: [
            { description: 'Supplies & equipment', costFormula: 'sqft * 0.03' },
            { description: 'Fuel & vehicle', costFormula: '35' },
          ],
        },
        {
          ...
          measurements: [
            ...
            { id: 'bathrooms', label: 'Number of Bathrooms', unit: 'each', placeholder: '2', required: true },
            { id: 'bedrooms', label: 'Number of Bedrooms', unit: 'each', placeholder: '3', required: true },
            { id: 'condition', label: 'Property Condition (1=Good, 2=Average, 3=Poor/dirty)', unit: '', placeholder: '2', required: true },
            { id: 'add_carpet', label: 'Carpet Rooms to Clean', unit: 'each', placeholder: '0', required: false },
          ],
          defaultMaterials: [
            { name: 'Heavy-Duty Cleaning Kit (lot)', category: 'Supplies', unit: 'kit', baseUnitCost: 45.00, quantityFormula: '1', notes: 'Full chemical kit' },
            { name: 'Oven/Grill Cleaner', category: 'Supplies', unit: 'bottle', baseUnitCost: 9.00, quantityFormula: '1', notes: '' },
            { name: 'Carpet Cleaner Solution (qt)', category: 'Supplies', unit: 'qt', baseUnitCost: 15.00, quantityFormula: '(add_carpet||0)', notes: '' },
            { name: 'Microfiber Cloths (pack)', category: 'Supplies', unit: 'pack', baseUnitCost: 12.00, quantityFormula: '2', notes: '' },
            { name: 'Scrub Pads / Brushes (set)', category: 'Supplies', unit: 'set', baseUnitCost: 8.00, quantityFormula: '2', notes: '' },
            { name: 'Trash Bags (box)', category: 'Supplies', unit: 'box', baseUnitCost: 9.00, quantityFormula: '1', notes: '' },
          ],
          defaultLabor: [
            { description: 'Full property deep clean', workers: 2, hoursFormula: 'Math.ceil(sqft * (condition||2) * 0.18 / 60)', ratePerHour: 35 },
            { description: 'Bathrooms (move-out standard)', workers: 1, hoursFormula: 'bathrooms * 1.25 * (condition||2)', ratePerHour: 35 },
            { description: 'Bedrooms & closets', workers: 1, hoursFormula: 'bedrooms * 1.0 * ((condition||2) > 1 ? 1.25 : 1.0)', ratePerHour: 35 },
            { description: 'Carpet cleaning', workers: 1, hoursFormula: '(add_carpet||0) * 0.75', ratePerHour: 35 },
          ],
          defaultOverhead: [
            { description: 'Supplies & equipment', costFormula: 'sqft * 0.04' },
            { description: 'Carpet cleaner rental', costFormula: '(add_carpet||0) > 0 ? 65 : 0' },
            { description: 'Fuel & vehicle', costFormula: '35' },
          ],
        },
      ],
